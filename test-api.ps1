...
$appointment = Invoke-RestMethod -Uri "http://localhost:3000/api/workstations/6c2d124d-9d19-496f-96a5-cee401e9fcde/appointments" -Method GET
...
if ($appointment.appointments.Length -gt 0) {
    ...
    $response = Invoke-RestMethod -Uri "http://localhost:3000/api/workstations/6c2d124d-9d19-496f-96a5-cee401e9fcde/appointments/$($firstAppointment.id)/status" -Method PUT -Body $body -ContentType "application/json"
    Write-Host "Update response:" $response
    
    # Check if it was updated
    $updatedAppointments = Invoke-RestMethod -Uri "http://localhost:3000/api/workstations/6c2d124d-9d19-496f-96a5-cee401e9fcde/appointments" -Method GET
